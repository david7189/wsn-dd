...
if [ -d ${SNEEROOT}/${username}_output ]; then
  rm -Rf ${SNEEROOT}/${username}_output
fi
mkdir ${SNEEROOT}/${username}_output
chmod -R 777 ${SNEEROOT}/${username}_output
#chown daemon ${SNEEROOT}/${username}_output
mkdir ${SNEEROOT}/${username}_output/query1
