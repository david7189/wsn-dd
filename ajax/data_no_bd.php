<?php
	...
	if(isset($_POST['action']) && $_POST['action'] == 'curr_conv2') {
		...
		#putenv('SNEEROOT=/home/david/SNEE-1.6.4-WSN-DD');
		#putenv('SNEEROOT=/home/david/SNEE-1.6.4-SNAPSHOT-WSNDD3');
		...
		$file2 = $id_usuario . '_snee_files.rar';
		if(strpos($sortie, '*O*K*') !== false && file_exists($file . $file2)) {
			if(!copy($file . $file2, '../downloads/snee_files.rar') ||
